...
namespace vk {
    ...
    public:
        ...
        size_t size() const { return m_info.getInfo().allocationSize; }
        uint32_t typeIndex() const { return m_info.getInfo().memoryTypeIndex; }
    ...
    private:
        ...
        Device* m_device;
        InfoChain<MemoryAllocateInfo> m_info;
        void* m_mapping;
